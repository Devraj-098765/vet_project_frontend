    ...
    <>
      ...
      <header className="relative mt-16 py-28 overflow-hidden">
        ...
        <div className="container mx-auto px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl mt-6 text-gray-100 font-sans font-light max-w-2xl tracking-wide">
      ...
      <section className="container mx-auto px-6 py-24 relative">
        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="md:w-1/2">
            <span className="text-green-700 uppercase tracking-widest text-sm font-sans font-medium">Our Philosophy</span>
            ...
            <p className="text-gray-700 leading-relaxed text-lg font-sans tracking-wide">
            ...
            <p className="text-gray-700 leading-relaxed text-lg mt-6 font-sans tracking-wide">
      ...
      <section className="py-24 relative overflow-hidden bg-green-50/40">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <span className="text-green-700 uppercase tracking-widest text-sm font-sans font-medium">Trust & Excellence</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="group">
              <div className="p-10 bg-white shadow-md rounded-lg hover:shadow-lg transition-all duration-500 border-b border-green-700">
                ...
                <h3 className="text-xl font-sans font-medium text-green-900 mb-2">Expert Veterinarians</h3>
                <div className="h-px w-12 bg-green-300 mx-auto mb-4"></div>
                <p className="text-gray-600 mt-4 font-sans">Our team is made up of the best professionals in the field.</p>
              </div>
            </div>
            ...
            <div className="group">
              <div className="p-10 bg-white shadow-md rounded-lg hover:shadow-lg transition-all duration-500 border-b border-green-700">
                ...
                <h3 className="text-xl font-sans font-medium text-green-900 mb-2">24/7 Emergency Services</h3>
                <div className="h-px w-12 bg-green-300 mx-auto mb-4"></div>
                <p className="text-gray-600 mt-4 font-sans">We are available around the clock for critical care.</p>
              </div>
            </div>
            ...
            <div className="group">
              <div className="p-10 bg-white shadow-md rounded-lg hover:shadow-lg transition-all duration-500 border-b border-green-700">
                ...
                <h3 className="text-xl font-sans font-medium text-green-900 mb-2">Easy Online Booking</h3>
                <div className="h-px w-12 bg-green-300 mx-auto mb-4"></div>
                <p className="text-gray-600 mt-4 font-sans">Schedule your appointments hassle-free.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="container mx-auto px-6 py-24">
        <div className="text-center mb-16">
          <span className="text-green-700 uppercase tracking-widest text-sm font-sans font-medium">Exceptional Care</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="group relative overflow-hidden">
            <div className="p-8 bg-white border border-gray-100 shadow-sm rounded-lg hover:shadow-md transition duration-300 group-hover:border-green-200">
              ...
              <h3 className="text-xl font-sans font-medium text-green-900">Preventive Health Checkups</h3>
              <div className="h-px w-12 bg-green-200 my-4 group-hover:w-16 transition-all duration-300"></div>
              <p className="text-gray-600 font-sans">Regular screenings and vaccinations for your pet.</p>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden">
            <div className="p-8 bg-white border border-gray-100 shadow-sm rounded-lg hover:shadow-md transition duration-300 group-hover:border-green-200">
              ...
              <h3 className="text-xl font-sans font-medium text-green-900">Advanced Surgery</h3>
              <div className="h-px w-12 bg-green-200 my-4 group-hover:w-16 transition-all duration-300"></div>
              <p className="text-gray-600 font-sans">State-of-the-art surgical care for various medical conditions.</p>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden md:col-span-2 lg:col-span-1">
            <div className="p-8 bg-white border border-gray-100 shadow-sm rounded-lg hover:shadow-md transition duration-300 group-hover:border-green-200">
              ...
              <h3 className="text-xl font-sans font-medium text-green-900">Diet & Nutrition Plans</h3>
              <div className="h-px w-12 bg-green-200 my-4 group-hover:w-16 transition-all duration-300"></div>
              <p className="text-gray-600 font-sans">Personalized meal plans for a balanced pet diet.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 relative overflow-hidden bg-green-900 text-white">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <span className="text-green-300 uppercase tracking-widest text-sm font-sans font-medium">Client Testimonials</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="relative">
              <div className="p-8 bg-green-800/50 rounded-lg backdrop-blur-sm border border-green-700/30">
                ...
                <p className="text-gray-100 italic relative z-10 text-lg font-sans">VetCare provided the best treatment for my dog. The staff is amazing!</p>
                <div className="mt-8 flex items-center justify-center">
                  <div className="w-10 h-10 bg-green-700 rounded-full mr-3"></div>
                  <div>
                    <h4 className="font-sans font-bold text-white text-sm">Alice M.</h4>
                    <p className="text-green-300 text-xs font-sans">Dog Owner</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="p-8 bg-green-800/50 rounded-lg backdrop-blur-sm border border-green-700/30">
                <div className="text-6xl text-green-500 opacity-30 absolute top-4 left-4">"</div>
                <p className="text-gray-100 italic relative z-10 text-lg font-sans">I trust VetCare for all my pets. Their online booking is super easy!</p>
                <div className="mt-8 flex items-center justify-center">
                  <div className="w-10 h-10 bg-green-700 rounded-full mr-3"></div>
                  <div>
                    <h4 className="font-sans font-bold text-white text-sm">John D.</h4>
                    <p className="text-green-300 text-xs font-sans">Cat Owner</p>
                  </div>
                </div>
              </div>
            </div>
