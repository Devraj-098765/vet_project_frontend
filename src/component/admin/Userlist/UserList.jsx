...
//   return (
//     <div className="flex bg-gradient-to-br from-[#f5f3f7] to-[#e6e0ed] min-h-screen text-[#4a4060]">
//       <AdminNavbar />
...
//               <div className="bg-[#9380b6] p-2 rounded-lg shadow-lg">
//                 <Users className="w-6 h-6 text-white" />
//               </div>
//               <h1 className="text-3xl font-bold text-[#5a4a70]">
//                 User List
//               </h1>
//             </div>
//             <div className="relative w-full md:w-72 lg:w-96">
//               <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
//                 <Search className="w-5 h-5 text-[#7a6a90]" />
//               </div>
//               <input
//                 type="text"
...
//                 className="pl-10 pr-4 py-3 w-full rounded-full border-2 border-[#d0c0e0] focus:border-[#9380b6] focus:ring focus:ring-[#d0c0e0] focus:ring-opacity-50 shadow-sm text-[#5a4a70]"
//               />
//             </div>
//           </div>
...
//           {error ? (
//             <motion.div
//               className="bg-[#f0e6f3] border-l-4 border-[#9380b6] p-4 rounded-md shadow-md"
//               initial={{ opacity: 0, y: 20 }}
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ duration: 0.5 }}
//             >
//               <p className="text-[#5a4a70] font-medium">Error: {error}</p>
//             </motion.div>
...
//                   className="relative overflow-hidden rounded-xl bg-white shadow-xl border border-[#e6d0f3] cursor-pointer group"
//                 >
//                   <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#9380b6] to-[#7a6a90] opacity-0 group-hover:opacity-100 transition-opacity"></div>
//                   <div className="p-6">
//                     <div className="flex items-center">
//                       <div className="bg-gradient-to-r from-[#9380b6] to-[#7a6a90] w-10 h-10 rounded-lg flex items-center justify-center text-white font-bold mr-4">
//                         {user.name.charAt(0).toUpperCase()}
//                       </div>
//                       <div className="flex-1">
//                         <h3 className="text-xl font-bold text-[#5a4a70]">{user.name}</h3>
//                         <p className="text-[#7a6a90]">{user.email}</p>
//                         <div className="text-sm text-[#9380b6] mt-2 flex items-center opacity-0 group-hover:opacity-100 transition-opacity">
...
//           ) : (
//             <motion.div
//               className="flex flex-col items-center justify-center p-12 bg-white rounded-xl shadow-lg border border-[#e6d0f3]"
//               initial={{ opacity: 0 }}
//               animate={{ opacity: 1 }}
//               transition={{ duration: 0.5 }}
//             >
//               <div className="bg-[#f0e6f3] p-4 rounded-full mb-4">
//                 <Users className="w-8 h-8 text-[#9380b6]" />
//               </div>
//               <p className="text-xl text-[#5a4a70] font-medium">No users found</p>
//             </motion.div>
//           )}
//         </motion.div>
...
//                 <button 
//                   onClick={closeUserDetails}
//                   className="absolute top-4 right-4 text-[#7a6a90] hover:text-[#5a4a70] transition-colors"
//                 >
//                   <X className="w-6 h-6" />
//                 </button>
                
//                 <div className="flex items-center mb-6">
//                   <div className="bg-gradient-to-r from-[#9380b6] to-[#7a6a90] w-16 h-16 rounded-xl flex items-center justify-center text-white font-bold mr-6 text-3xl">
//                     {selectedUser.name.charAt(0).toUpperCase()}
//                   </div>
//                   <div>
//                     <h2 className="text-2xl font-bold text-[#5a4a70]">{selectedUser.name}</h2>
//                     <p className="text-[#7a6a90]">{selectedUser.email}</p>
//                   </div>
//                 </div>
                
//                 <div className="bg-[#f5f3f7] rounded-xl p-6 space-y-4">
//                   <div>
//                     <span className="block text-[#7a6a90] font-semibold mb-1">User ID</span>
//                     <p className="text-[#5a4a70] bg-white p-3 rounded-lg break-all">{selectedUser._id}</p>
//                   </div>
//                   <div>
//                     <span className="block text-[#7a6a90] font-semibold mb-1">User Role</span>
//                     <p className="text-[#5a4a70] bg-white p-3 rounded-lg">{selectedUser.role || "User"}</p>
//                   </div>
//                   <div>
//                     <span className="block text-[#7a6a90] font-semibold mb-1">Joined Date</span>
//                     <p className="text-[#5a4a70] bg-white p-3 rounded-lg">
