  ...
  return (
    <>
      ...
      <div className="relative h-screen">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-green-900/60 to-green-700/60 z-0" />
      ...
      <section className="relative bg-green-50 py-24">
        ...
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-green-100 rounded-full -ml-24 -mb-24 opacity-50" />
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid gap-12 md:grid-cols-2">
            ...
            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-green-400 to-teal-400 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-300" />
              <div className="relative bg-white p-8 rounded-xl shadow-xl flex flex-col h-full transform group-hover:-translate-y-2 transition duration-300">
                ...
                <div className="mt-8">
                  <NavLink
                    to="https://www.youtube.com/watch?v=nhRibVjN9YM&list=PL317cw1gUhCRpFkqX4lYlEOyNVZigSGU9"
            ...
            {/* Clinic Visit Card */}
            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-teal-400 to-green-400 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-300" />
              <div className="relative bg-white p-8 rounded-xl shadow-xl flex flex-col h-full transform group-hover:-translate-y-2 transition duration-300">
                <div className="relative mb-8 overflow-hidden rounded-xl">
                  <img
