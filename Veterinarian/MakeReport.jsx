...
const MakeReport = () => {
  ...
  const handleReportSubmit = async (e) => {
    ...
    try {
      ...
      setSubmitted(true);
      toast.success("Report submitted and appointment marked as completed!");

      // Dispatch custom event to trigger stats refresh in VetDashboard
      ...
      toast.error("Failed to submit report or update status");
    } finally {
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleInputChange}
                        className={`w-full p-2 border rounded ${
                          validationErrors.treatment ? "border-red-500" : "border-gray-300"
                        }`}
                        rows="3"
