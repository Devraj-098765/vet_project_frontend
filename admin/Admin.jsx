    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-white shadow-lg p-6 flex flex-col justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-800 flex items-center justify-between">
            VetCare Admin <FiBell className="cursor-pointer hover:text-blue-500 transition-colors" />
          </h2>
          <nav className="mt-8">
      ...
      <main className="flex-1 p-8">
        ...
        <div className="flex justify-between items-center bg-white shadow-md rounded-lg px-6 py-4 mb-6">
          ...
          <button className="bg-blue-600 hover:bg-blue-700 px-4 py-2 text-md text-white rounded-lg shadow"> Log out</button>
        </div>

        {/* Overview Cards */}
        <div className="grid grid-cols-3 gap-4">
          {[
            { title: "Total Animals", count: totalAnimals, color: "text-blue-600", icon: <FiHeart /> },
...
export default VetCareAdminDashboard;
